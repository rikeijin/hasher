...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.browse.setGeometry(QtCore.QRect(584, 18, 91, 31))
        font = QtGui.QFont()
        ...
        self.hash.setGeometry(QtCore.QRect(24, 138, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.hash_result.setGeometry(QtCore.QRect(24, 188, 551, 41))
        font = QtGui.QFont()
        ...
        self.compare_value.setGeometry(QtCore.QRect(24, 238, 551, 41))
        font = QtGui.QFont()
        font.setFamily("Courier")
        font.setPointSize(8)
        ...
        self.compare.setGeometry(QtCore.QRect(584, 188, 91, 91))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.match_label.setGeometry(QtCore.QRect(434, 288, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.progressBar.setGeometry(QtCore.QRect(124, 138, 451, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.file_path = QtWidgets.QComboBox(self.centralwidget)
        self.file_path.setGeometry(QtCore.QRect(24, 18, 561, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.file_path.setFont(font)
        self.file_path.setAcceptDrops(True)
        self.file_path.setEditable(True)
        self.file_path.setInsertPolicy(QtWidgets.QComboBox.InsertAtCurrent)
        self.file_path.setObjectName("file_path")
        self.radio_md5 = QtWidgets.QRadioButton(self.centralwidget)
        self.radio_md5.setGeometry(QtCore.QRect(45, 80, 40, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.radio_sha1.setGeometry(QtCore.QRect(143, 80, 45, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.radio_sha256.setGeometry(QtCore.QRect(240, 80, 56, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        MainWindow.setTabOrder(self.file_path, self.browse)
        MainWindow.setTabOrder(self.browse, self.radio_md5)
        MainWindow.setTabOrder(self.radio_md5, self.radio_sha1)
        MainWindow.setTabOrder(self.radio_sha1, self.radio_sha256)
        MainWindow.setTabOrder(self.radio_sha256, self.hash)
        MainWindow.setTabOrder(self.hash, self.compare)
        MainWindow.setTabOrder(self.compare, self.compare_value)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_path.setCurrentText(_translate("MainWindow", "Paste or browse to the file you want to check."))
